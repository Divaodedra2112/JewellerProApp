...
import { HomeIcon, NotificationIcon as NotificationSVGIcon, ChatIcon } from '../assets/icons/svgIcons/appSVGIcons';
...
export const navigationModulesConfig: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: ({ color, focused }) => (
      <ChatIcon width={focused ? 24 : 20} height={focused ? 24 : 20} color={color} />
    ),
    type: 'bottomTab',
    permissionKey: 'list',
  },
  {
    ...
    icon: ({ color, focused }) => (
      <View style={{ position: 'relative' }}>
        <NotificationSVGIcon width={focused ? 24 : 20} height={focused ? 24 : 20} color={color} />
        {/* Notification badge */}
        <View
          style={{
            position: 'absolute',
  ...
  },
  {
    ...
    icon: ({ color, focused }) => {
      ...
      return (
        <Svg width={focused ? 24 : 20} height={focused ? 24 : 20} viewBox="0 0 24 24" fill="none">
          <Path
